					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form class="form-horizontal form-material"
								...
								<!-- id task dùng để update -->
								<input type="hidden" name="id" value="${task.id}">

								<div class="form-group">
									<label class="col-md-12">Tên dự án</label>
									<div class="col-md-12">
										<input type="text" readonly value="${task.jobName}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" readonly value="${task.startDate}"
											class="form-control form-control-line">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" readonly value="${task.endDate}"
											class="form-control form-control-line">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select name="statusId" class="form-control form-control-line">
											<option value="1" ${task.statusId == 1 ? "selected" : ""}>
												Chưa thực hiện</option>

											<option value="2" ${task.statusId == 2 ? "selected" : ""}>
												Đang thực hiện</option>

											<option value="3" ${task.statusId == 3 ? "selected" : ""}>
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" class="btn btn-success">Lưu lại
										</button>
