			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="${pageContext.request.contextPath}/job-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${listJobs}" var="item" varStatus="loop">
											<tr>
												<td>${loop.index + 1}</td>
												<td>${item.name}</td>
												...
												<td>${item.endDate}</td>
												<td><a
													href="${pageContext.request.contextPath}/job?action=edit&id=${item.id}"
													class="btn btn-sm btn-primary"> Sửa </a> <a
													href="${pageContext.request.contextPath}/job?action=delete&id=${item.id}"
													class="btn btn-sm btn-danger"> Xóa </a> <a
													href="${pageContext.request.contextPath}/job?action=detail&id=${item.id}"
